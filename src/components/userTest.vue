<template>
  <div class="p-2">
    ...
    <div>{{ fullname }}</div>
    <el-button class="mt-3" type="primary" @click="changeObj">更改reactive </el-button>
    <!-- computed -->
    <el-input
    ...
    <!-- watch -->
    <el-input style="width: 100px; margin-top: 10px; display: block" v-model="fullName3" clearable></el-input>
